...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object handler) throws Exception {
        ...
        if(handler instanceof HandlerMethod) {
            ...
            if (method.getDeclaringClass().isAnnotationPresent(SSOWebRequired.class)) {
                ...
                SSOWebRequired annotation = method.getDeclaringClass().getAnnotation(SSOWebRequired.class);

                String sid = annotation.sid();
                float loginStore = annotation.loginScore();
